namespace Prototype.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Prototype.ApplicationDatabase.ApplicationContext>
    {
        ...
        protected override void Seed(Prototype.ApplicationDatabase.ApplicationContext context)
        {
            ...
            Student s3 = new Student() { FirstName = "Eleni", LastName = "Adamantopoulou", Phone = "2104411202", Email = "eleni.a@gmail.com", TuitionFees = 2200, Age = 30 };
            ...
            Trainer t4 = new Trainer() { FirstName = "Menelaos", LastName = "AdamantopouloS", Phone = "214748449", Email = "christinapapa@gmail.com", Salary = 3500, Age = 41, Subject = Subject.JS_FUNDENMENTALS };
